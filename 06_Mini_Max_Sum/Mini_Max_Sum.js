...
miniMaxSum has the following parameter(s): arr: an array of  integers
...
const miniMaxSum = (num) => {
    let sortNumersMinimum = [...num]
    let sortNumersMaximum = [...num]
    let arrayMin
    let arrayMax
    let totalMin
    let totalMax
    ...
    arrayMin = sortNumersMinimum.splice(0,sortNumersMinimum.length-1)
    arrayMax = sortNumersMaximum.splice(1,sortNumersMaximum.length)
